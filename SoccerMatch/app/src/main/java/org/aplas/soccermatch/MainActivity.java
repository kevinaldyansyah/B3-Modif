...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText homeTeam, awayTeam, homeCoach, awayCoach;
    ...
    private ArrayList<StadionItem> mStadionList;
    private StadionAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awayCoach = (EditText) findViewById(R.id.awayCoach);
        homeCoach = (EditText) findViewById(R.id.homeCoach);
        ...
        initList();
        Spinner spinnerStadion = findViewById(R.id.spinner_stadion);
        mAdapter = new StadionAdapter(this, mStadionList);
        spinnerStadion.setAdapter(mAdapter);
    ...
    private void initList() {
        mStadionList = new ArrayList<>();
        mStadionList.add(new StadionItem("Manahan", R.drawable.manahan));
        mStadionList.add(new StadionItem("Kanjuruhan", R.drawable.kanjuruhan));
        mStadionList.add(new StadionItem("GBK", R.drawable.gbk));
        mStadionList.add(new StadionItem("Gajayana", R.drawable.gajayana));
    }
    ...
    private boolean isFormComplete() {
        ...
        if (homeCoach.getText().toString().isEmpty()) {
            Toast.makeText(MainActivity.this, "Home Coach name is still empty", Toast.LENGTH_LONG).show();
            return false;
        }
        if (awayCoach.getText().toString().isEmpty()) {
            Toast.makeText(MainActivity.this, "Away Coach name is still empty", Toast.LENGTH_LONG).show();
            return false;
        }
    ...
    private void openPlayActivity() {
        ...
        play.putExtra("HOME_COACH", homeCoach.getText().toString());
        play.putExtra("AWAY_COACH", awayCoach.getText().toString());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.nav_berita:
                Toast.makeText(this, "Jadwal Page Selected", Toast.LENGTH_SHORT).show();
